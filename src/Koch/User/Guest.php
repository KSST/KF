...
class Guest
{
    ...
    {
        $this->config = \Clansuite\Application::getInjector()->instantiate(Koch\Config\Config::class);
         ...
         */
        if (!isset($_SESSION['user']['language_via_url']) and isset($this->config['locale']['locale'])) {
